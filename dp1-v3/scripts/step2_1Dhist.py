...
def parse_args():
    ...
    p.add_argument("--bands", default="lsst_g,lsst_r,lsst_i,lsst_z",
                   help="comma-separated bands to histogram (default: "
                        "lsst_g,lsst_r,lsst_i,lsst_z; 6-band: "
...
def _band_short(band):
    """Strip an optional ``lsst_`` prefix for label / color lookup."""
    return band[len("lsst_"):] if band.startswith("lsst_") else band
